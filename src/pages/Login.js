...
const Login = () => {
    ...
    if (error || gError || fError || tError) {
        signInError = <p className='text-red-500'>
            <small>
                {
                    error?.message || gError?.message || fError?.message || tError?.message
                }
            </small>
        </p>
    }
                ...
                <div className="card-body">
                    ...
                    >
                        ...
                        <div className="form-control">
                            ...
                            <label className="label">
                                <Link to='' className="label-text-alt link link-hover">Forgot password? <span className='text-secondary'>Reset Password</span></Link>
                            </label>
                            <label className="label">
                                <Link to='/signup' className="label-text-alt link link-hover">New to here? <span className='text-secondary'>Create a new account</span></Link>
                            </label>
                        </div>
