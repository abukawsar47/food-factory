                ...
                <div className='lg:p-10 p-5  w-full bg-base-100 shadow-xl rounded-2xl'>
                    ...
                    >
                        <div className='flex lg:flex-row flex-col  gap-5'>
                            <div className="form-control lg:mt-3 w-full">
                                <label className="label">
                                    <span className="label-text font-bold text-lg">Name <span className='text-secondary'>*</span></span>
                                </label>
                                <input type="text" name="name" placeholder="Your Name" className="input input-bordered w-full" required />
                            </div>
                            <div className="form-control lg:mt-3 w-full">
                                <label className="label">
                                    <span className="label-text font-bold text-lg">Email <span className='text-secondary'>*</span></span>
                                </label>
                        ...
                        <div className='flex lg:flex-row flex-col  gap-5'>
                            <div className="form-control lg:mt-3 w-full">
                                <label className="label">
                                    <span className="label-text font-bold text-lg">Subject <span className='text-secondary'>*</span></span>
                                </label>
                                <input type="text" name="subject" placeholder="Subject" className="input input-bordered w-full" required />
                            </div>
                            <div className="form-control lg:mt-3 w-full">
                                <label className="label">
                                    <span className="label-text font-bold text-lg">Phone <span className='text-secondary'>*</span></span>
                                </label>
                                <input type="tel" name="number" placeholder="Your Contact Number" className="input input-bordered w-full" required min="0" />
                            </div>
                        </div>
                        <div className="form-control mt-3 w-full">
                            ...
                            <textarea type="text" name="message" placeholder="Message..." className="input input-bordered w-full lg:h-[180px] h-[90px] pt-3" required />
                        </div>
                        <div className="form-control  w-full">
                            <div className='lg:mt-10 mt-6 text-center'>
                                <button type='submit' className="btn btn-primary hover:btn-secondary duration-1000 font-bold px-10">GET IN TOUCH</button>
                            </div>
                        </div>
                    </form>
                </div>
